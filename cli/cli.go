...
var BotToken, _ = os.LookupEnv("TOKEN")
			...
			Options: []*discordgo.ApplicationCommandOption{
...

				{
					...
					Options: []*discordgo.ApplicationCommandOption{
						...
						{
							Name:        "user",
							Description: "Get a Users Birthday",
							Type:        discordgo.ApplicationCommandOptionSubCommand,
						},
						{
							Name:        "all",
							Description: "Get all User's Birthdays",
							Type:        discordgo.ApplicationCommandOptionSubCommand,
						},
					},
